  ...
  return (
    ...
    >
      <div className="relative z-10">
        ...
        <div
          className={`sidebar-info_more mt-8 overflow-hidden transition-all duration-500 ease-in-out ${
            showContacts ? "max-h-[500px]" : "max-h-0"
          }`}
        >
          ...
          <ul className="contacts-list space-y-6">
            <li className="contact-item flex items-center group">
              ...
              <div className="contact-info">
                <p className="contact-title text-xs text-white/70 uppercase tracking-wider mb-1">
                  Email
                </p>
                <a
                  href="mailto:salhseid@gmail.com"
                  className="contact-link text-lg font-medium text-white hover:text-yellow-400 transition-colors"
                >
                  salhseid@gmail.com
                </a>
              </div>
          ...
          <div className="text-center mb-4">
            ...
            <ul className="social-list flex justify-center space-x-5">
              <li className="social-item">
                <a
                  href="#"
                  className="social-link bg-white/10 backdrop-blur-lg p-3 rounded-xl inline-block hover:bg-blue-600 text-white hover:text-white transition-all transform hover:-translate-y-1 shadow-lg"
                >
              ...
              <li className="social-item">
                <a
                  href="#"
                  className="social-link bg-white/10 backdrop-blur-lg p-3 rounded-xl inline-block hover:bg-blue-500 text-white hover:text-white transition-all transform hover:-translate-y-1 shadow-lg"
                >
              ...
              <li className="social-item">
                <a
                  href="#"
                  className="social-link bg-white/10 backdrop-blur-lg p-3 rounded-xl inline-block hover:bg-pink-600 text-white hover:text-white transition-all transform hover:-translate-y-1 shadow-lg"
                >
              ...
              <li className="social-item">
                <a
                  href="#"
                  className="social-link bg-white/10 backdrop-blur-lg p-3 rounded-xl inline-block hover:bg-blue-400 text-white hover:text-white transition-all transform hover:-translate-y-1 shadow-lg"
                >
